...
public class SeedDataService {
    ...
    private List<ProductSeed> productSeeds() {
        return List.of(
                new ProductSeed("NB-001", "Notebook Acer Aspire", "Notebook Acer Aspire com processador Intel, tela 15.6\" Full HD, SSD rapido e bateria de longa duracao. Ideal para trabalho e estudos.", "Notebooks", new BigDecimal("3500.00"), 20, "https://m.media-amazon.com/images/I/512JJoQh4lL._AC_SY300_SX300_QL70_ML2_.jpg"),
                new ProductSeed("MS-001", "Mouse Logitech M170", "Mouse optico Logitech M170 com conexao sem fio 2.4GHz. Design ambidestro e bateria com ate 12 meses de duracao.", "Acessorios", new BigDecimal("80.00"), 100, "https://images.unsplash.com/photo-1677019758488-ca44c974ef62?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"),
                new ProductSeed("KB-001", "Teclado Mecanico Redragon", "Teclado mecanico Redragon com switches azuis, iluminacao RGB e estrutura reforcada. Ideal para gamers e digitacao intensa.", "Acessorios", new BigDecimal("250.00"), 50, "https://m.media-amazon.com/images/I/71FSIp+tDNL._AC_UF894,1000_QL80_.jpg"),
                new ProductSeed("MN-001", "Monitor 24 LG IPS", "Monitor LG IPS de 24 polegadas Full HD com tempo de resposta de 5ms. Tecnologia AH-IPS para cores precisas em qualquer angulo.", "Monitores", new BigDecimal("1200.00"), 30, "https://media.pichau.com.br/media/catalog/product/cache/2f958555330323e505eba7ce930bdf27/2/4/24ms500-b.jpg"),
                new ProductSeed("HS-001", "Headset HyperX Cloud", "Headset gamer HyperX Cloud com som surround 7.1, microfone destacavel e almofadas em memory foam para uso prolongado.", "Audio", new BigDecimal("450.00"), 40, "https://m.media-amazon.com/images/I/71pFeJFdJQL._AC_UF894,1000_QL80_.jpg"),
                new ProductSeed("WC-001", "Webcam Logitech C920", "Webcam Logitech C920 com gravacao Full HD 1080p, microfone estereo e correcao automatica de iluminacao. Otima para videochamadas.", "Acessorios", new BigDecimal("600.00"), 25, "https://m.media-amazon.com/images/I/413c3lWANvL.jpg"),
                new ProductSeed("CB-001", "Cabo HDMI 2m", "Cabo HDMI 2.0 de 2 metros com suporte a 4K 60Hz e canal de retorno de audio (ARC). Conectores banhados a ouro.", "Cabos", new BigDecimal("20.00"), 200, "https://images.kabum.com.br/produtos/fotos/sync_mirakl/189684/xlarge/Cabo-HDMI-2-0-4K-3D-Ultra-HD-19-Pinos-Tv-Compat-vel-Com-PS3-PS4-PS5-2-Metros-018-2222_1775072353.jpg"),
                new ProductSeed("PD-001", "Pendrive Sandisk 64GB", "Pendrive Sandisk 64GB USB 3.0 com velocidade de transferencia de ate 100MB/s. Design compacto e duravel.", "Armazenamento", new BigDecimal("70.00"), 80, "https://media.pichau.com.br/media/catalog/product/cache/2f958555330323e505eba7ce930bdf27/s/d/sdcz50-064g-b351.jpg")
        );
    }
