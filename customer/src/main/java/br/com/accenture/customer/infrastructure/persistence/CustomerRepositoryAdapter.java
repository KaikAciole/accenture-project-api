...
public class CustomerRepositoryAdapter implements CustomerRepository {
    ...
    @Override
    public PageResult<Customer> findByNameContainingIgnoreCase(String name, PageRequest pageRequest) {
        Pageable pageable = SpringPaginationConverter.toPageable(pageRequest);
        Page<Customer> page = jpaRepository.findByNameContainingIgnoreCase(name, pageable)
