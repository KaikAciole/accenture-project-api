...
class PersistenceMapperTest {
    ...
    void productMapsBetweenDomainAndEntity() {
        ...
        Product product = Product.restore(id, "SKU-001", "Notebook", "Electronics", BigDecimal.TEN, 5, 3L);
    ...
    void stockReservationMapsBetweenDomainAndEntity() {
        Product product = Product.restore(UUID.randomUUID(), "SKU-001", "Notebook", "Electronics", BigDecimal.TEN, 5, 0L);
